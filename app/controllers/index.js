...
exports.register = function(req,res){
	var name = req.body.name;
      ...
      //test = bcrypt.compareSync(password,"$2a$10$yXikt/yivhq.An.xVj/Vv.hK2z.SuxsfByA0BtIGuEuLJlcgjsawC");

     var queryString = "INSERT INTO tbl_users (id,user_role,username,user_password,created_at) VALUES('"+id+"','"+user_role+"','"+name+"','"+hash+"','"+created_at+"')";
...
exports.getDebtReport = function(req,res){
     var query = client.query('SELECT * FROM tbl_due_listing');
          ...
          query.on("end",function(result){
              res.send({
              	'error':false,
              	'message':'returning debt reports',
              	'data':result.rows,
              });
          });
